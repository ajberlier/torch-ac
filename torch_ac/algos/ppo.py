...
class PPOAlgo(BaseAlgo):
    ...
    def __init__(self, envs, arch, device=None, num_frames_per_proc=None, discount=0.99, lr=0.001, gae_lambda=0.95,
        ...
        self.optimizer = torch.optim.Adam(self.arch.parameters(), lr, eps=adam_eps)
        self.batch_num = 0
